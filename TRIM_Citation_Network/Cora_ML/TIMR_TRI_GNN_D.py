...
cora_wasserstein_distance_dataset = pd.read_csv(path + "Cora_ML_wasserstein_distance_mat.csv", index_col= 0)
...
topo_features = (topo_normalization(cora_wasserstein_distance).dot(node_features_arr) + node_features_arr)/2.
